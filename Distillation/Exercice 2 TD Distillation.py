...
while abs(Objfunction) >= abs(epsilon):
    ksi = ksi-((RR(Z1, Z2, Z3, Z4, K1, K2, K3, K4))/(RRD(Z1, Z2, Z3, Z4, K1, K2, K3, K4)))
    Objfunction = RR(Z1, Z2, Z3, Z4, K1, K2, K3, K4)
print ("valeur de ksi ", " est =", ksi)
print("valeur de Objfunction ", "est =", Objfunction)

V = F*ksi
print ("valeur de V ", " est =", V)
x1 = Z1/(1+ksi*(K1-1))
print ("valeur de x1 ", " est =", x1)
x2 = Z2/(1+ksi*(K2-1))
print ("valeur de x2 ", " est =", x2)
x3 = Z3/(1+ksi*(K3-1))
print ("valeur de x3 ", " est =", x3)
x4 = Z4/(1+ksi*(K4-1))
print ("valeur de x4 ", " est =", x4)
y1 = x1*K1
print ("valeur de y1 ", " est =", y1)
y2 = x2*K2
print ("valeur de y2 ", " est =", y2)
y3 = x3*K3
print ("valeur de y3 ", " est =", y3)
y4 = x4*K4
print ("valeur de y4 ", " est =", y4)
L = F-V
print ("valeur de L ", " est =", L)
